...
public class CronTest {
	...
	public void testEveryMinuteEveryHourEveryDayEveryMonthEveryDayOfWeek() {
		CronExpression cron =
			Cron.cron().everyMinute().everyHour().everyDay().everyMonth().everyDayOfWeek().get();
	...
	public void testMinutePeriod_severalMinutes_severalHours_twoDays() {
		CronPeriodExpression cron =
			Cron.cron()
				.from(25, 15, LocalDate.of(2017, 6, 15))
				.until(25, 21, LocalDate.of(2017, 6, 16))
				.get();
	...
	public void testMinutePeriod_severalMinutes_severalHours_severalDays_singleMonth() {
		CronPeriodExpression cron =
			Cron.cron()
				.from(25, 15, LocalDate.of(2017, 6, 15))
				.until(25, 21, LocalDate.of(2017, 6, 27))
				.get();
	...
	public void testMinutePeriod_severalMinutes_severalHours_severalDays_twoMonths() {
		CronPeriodExpression cron =
			Cron.cron()
				.from(25, 15, LocalDate.of(2017, 6, 15))
				.until(25, 21, LocalDate.of(2017, 7, 27))
				.get();
	...
	public void testMinutePeriod_severalMinutes_severalHours_severalDays_severalMonths() {
		CronPeriodExpression cron =
			Cron.cron()
				.from(25, 15, LocalDate.of(2017, 6, 15))
				.until(25, 21, LocalDate.of(2017, 11, 27))
				.get();
	...
	public void testMinutePeriod_severalMinutes_severalHours_severalDays_severalMonths_specificDaysOfTheWeek() {
		CronPeriodExpression cron =
			Cron.cron()
				.from(25, 15, LocalDate.of(2017, 6, 15))
				.until(25, 21, LocalDate.of(2017, 11, 27))
				.onTheseDaysOfTheWeek(DayOfWeek.MONDAY, DayOfWeek.FRIDAY)
				.get();
		assertEquals(7, cron.size());
	...
	public void testEveryMinuteWithDayAndDatePeriodWithinOneDay() {
		CronPeriodExpression cron =
			Cron.cron()
				.everyMinute()
				.from(12, LocalDate.of(2017, 6, 15))
				.until(20, LocalDate.of(2017, 6, 15))
				.get();
		assertEquals(1, cron.size());
	...
	public void testEveryMinuteDayAndDatePeriod() {
		CronPeriodExpression cron =
			Cron.cron()
				.everyMinute()
				.from(12, LocalDate.of(2017, 6, 15))
				.until(15, LocalDate.of(2017, 6, 16))
				.get();
		assertEquals(2, cron.size());
	...
	public void testEveryMinuteDayAndDatePeriodOverMultipleDays() {
		CronPeriodExpression cron =
			Cron.cron()
				.everyMinute()
				.from(12, LocalDate.of(2017, 6, 15))
				.until(15, LocalDate.of(2017, 6, 20))
				.get();
		assertEquals(3, cron.size());
		assertEquals("* 12-24 15 6 *", cron.get(0).toString());
	...
	public void testEveryMinuteDayAndDatePeriodOverMultipleDaysAndMultipleMonths() {
		CronPeriodExpression cron =
			Cron.cron()
				.everyMinute()
				.from(18, LocalDate.of(2017, 6, 15))
				.until(6, LocalDate.of(2017, 10, 5))
				.get();
		assertEquals(5, cron.size());
	...
	public void testEveryMinuteDayAndDatePeriodFromEqualsUntil() {
		...
		LocalDate date = LocalDate.of(2017, 6, 15);
		CronPeriodExpression cron =
			Cron.cron().everyMinute().from(hour, date).until(hour, date).get();
		assertEquals(1, cron.size());
	...
	public void testEveryMinuteWithDayAndDatePeriodUntilHourBeforeFromHour() {
		try {
			Cron.cron()
				.everyMinute()
				.from(12, LocalDate.of(2017, 6, 15))
				.until(6, LocalDate.of(2017, 6, 15))
				.get();
			fail();
		} catch (Exception e) {
		}
	...
	public void testEveryMinuteDayAndDatePeriodUntilDateBeforeFromDate() {
		try {
			Cron.cron()
				.everyMinute()
				.from(6, LocalDate.of(2017, 6, 15))
				.until(12, LocalDate.of(2017, 6, 14))
				.get();
			fail();
		} catch (Exception e) {
		}
	...
	public void testEveryMinuteDayAndDatePeriodCertainDaysOfWeek() {
		CronPeriodExpression cron =
			Cron.cron()
				.everyMinute()
				.everyHour()
				.from(LocalDate.of(2017, 6, 15))
				.until(LocalDate.of(2017, 6, 15))
				.fromDayOfWeek(DayOfWeek.SATURDAY)
				.untilDayOfWeek(DayOfWeek.SUNDAY)
				.get();
		assertEquals(1, cron.size());
	...
	public void testEveryMinuteEveryHourDatePeriodFromEqualsUntil() {
		LocalDate date = LocalDate.of(2017, 6, 15);
		CronPeriodExpression cron =
			Cron.cron().everyMinute().everyHour().from(date).until(date).get();
		assertEquals(1, cron.size());
	...
	public void testSeveralSpecificMonths() {
		CronExpression cron =
			Cron.cron()
				...
				.everyHour()
				.everyDay()
				.inTheseMonths(Month.JANUARY, Month.MARCH, Month.DECEMBER)
				.everyDayOfWeek()
				.get();
	...
	@Test
	public void testRandomMinuteEveryHourFromUntilDayRange() {
		CronPeriodExpression cron =
			Cron.cron()
				.aRandomMinute()
				.everyHour()
				.from(LocalDate.of(2018, 1, 31))
				.until(LocalDate.of(2018, 2, 4))
				.get();
		assertEquals(2, cron.size());
		assertEquals("H * 31 1 *", cron.get(0).toString());
		assertEquals("H * 1-4 2 *", cron.get(1).toString());
	}
	...
	public void testMonthRangeEqualValues() {
		try {
			Cron.cron()
				...
				.everyHour()
				.everyDay()
				.fromMonth(Month.OCTOBER)
				.untilMonth(Month.OCTOBER)
				.everyDayOfWeek()
				.get();
			fail();
		} catch (Exception e) {
	...
	public void testMonthRangeFromGreaterThanUntil() {
		try {
			Cron.cron()
				...
				.everyHour()
				.everyDay()
				.fromMonth(Month.DECEMBER)
				.untilMonth(Month.NOVEMBER)
				.everyDayOfWeek()
				.get();
		} catch (Exception e) {
	...
	public void testSeveralSpecificDaysOfTheWeek() {
		CronExpression cron =
			Cron.cron()
				...
				.everyDay()
				.everyMonth()
				.onTheseDaysOfTheWeek(DayOfWeek.MONDAY, DayOfWeek.THURSDAY, DayOfWeek.SUNDAY)
				.get();
	...
	public void testOneSpecificDayOfTheWeek() {
		CronExpression cron =
			Cron.cron()
				...
				.everyDay()
				.everyMonth()
				.onTheseDaysOfTheWeek(DayOfWeek.SATURDAY)
				.get();
		assertEquals("* * * * 6", cron.toString());
	}
	...
	public void testDayOfWeekRangeEqualValues() {
		try {
			Cron.cron()
				...
				.everyDay()
				.everyMonth()
				.fromDayOfWeek(DayOfWeek.WEDNESDAY)
				.untilDayOfWeek(DayOfWeek.WEDNESDAY)
				.get();
			fail();
		} catch (Exception e) {
		}
	...
	public void testDayOfWeekRangeFromGreaterThanUntil() {
		try {
			Cron.cron()
				...
				.everyDay()
				.everyMonth()
				.fromDayOfWeek(DayOfWeek.TUESDAY)
				.untilDayOfWeek(DayOfWeek.MONDAY)
				.get();
		} catch (Exception e) {
	...
	public void testHourRangeWithDefaultValues() {
		CronExpression cron =
			Cron.cron().fromMinute(22).untilMinute(24).fromHour(6).untilHour(9).get();
	...
	public void testSpecificDaysWithDefaultValues() {
		CronExpression cron =
			Cron.cron().everyMinute().inTheseHours(19, 21, 23).onTheseDays(1, 2, 3).get();
	...
	public void testEveryMonthWithDefaultValues() {
		CronExpression cron =
			Cron.cron().inTheseMinutes(0, 59).everyHour().everyDay().everyMonth().get();
		assertEquals("0,59 * * * *", cron.toString());
	}
	...
	public void testSpecificMonthsWithDefaultValues() {
		CronExpression cron =
			Cron.cron()
				.everyMinute()
				.inTheseHours(19, 21, 23)
				.everyDay()
				.inTheseMonths(Month.MARCH, Month.JUNE)
				.get();
	...
	public void testMonthRangeWithDefaultValues() {
		CronExpression cron =
			Cron.cron()
				...
				.fromDay(2)
				.untilDay(4)
				.fromMonth(Month.APRIL)
				.untilMonth(Month.SEPTEMBER)
				.get();
